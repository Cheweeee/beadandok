...
namespace ELTE.TicTacToeGame.Persistence
{
    ...
    /// </summary>
    public class TicTacToeFileDataAccess : ITicTacToeDataAccess
    {
        /// <summary>
        /// Fájl betöltése.
        /// </summary>
        ...
        public async Task<Player[]> LoadAsync(String path)
        {
            ...
            {
                throw new TicTacToeDataException("Error occured during reading.");
            }
        }
        ...
        public async Task SaveAsync(String path, Player[] values)
        {
            ...
            {
                throw new TicTacToeDataException("Error occured during writing.");
            }
        }
    }
}
